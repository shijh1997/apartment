...
public class RoomController {
    ...
    public Result updateReleaseStatusById(Long id, ReleaseStatus status) {
        ...
        roomInfoLambdaQueryWrapper.eq(RoomInfo::getIsRelease,status);
        roomInfoService.update(roomInfoLambdaQueryWrapper);
        return Result.ok();
    }
    ...
    public Result<List<RoomInfo>> listBasicByApartmentId(Long id) {
        LambdaQueryWrapper<RoomInfo> selectQueryWrapper = new LambdaQueryWrapper<>();
        selectQueryWrapper.eq(RoomInfo::getApartmentId,id);
        selectQueryWrapper.eq(RoomInfo::getIsRelease,ReleaseStatus.RELEASED);
        List<RoomInfo> list = roomInfoService.list(selectQueryWrapper);
