...
public class SystemPostController {
    ...
    private Result<IPage<SystemPost>> page(@RequestParam long current, @RequestParam long size) {
        ...
        Page<SystemPost> page = service.page(systemPostPage);
    ...
    public Result updateStatusByPostId(@RequestParam Long id, @RequestParam BaseStatus status) {
        LambdaUpdateWrapper<SystemPost> upWp = new LambdaUpdateWrapper<>();
        upWp.eq(SystemPost::getId,id);
        upWp.set(SystemPost::getStatus,status);
        service.update(upWp);
        return Result.ok();
    }
}
