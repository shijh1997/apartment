...
public class RoomInfoServiceImpl extends ServiceImpl<RoomInfoMapper, RoomInfo>
    ...
    @Override
    public IPage<RoomItemVo> SelectRoom(Page<RoomItemVo> page, RoomQueryVo queryVo) {
        return roomInfoMapper.SelectRoom(page, queryVo);
    }

    @Override
    public RoomDetailVo SelectRoomDetail(Long id) {
        ...
        //3、查配套
        List<FacilityInfo> facilityInfoList = facilityMapper.selectListByRoomId(id);
        //4、查标签
        List<LabelInfo> labelInfoList =  labelMapper.selectListByRoomId(id);
        //5、查支付方式
